...
user: "I need to implement media uploads using the WordPress REST API"
assistant: "I'll use the framework-docs-researcher agent to gather comprehensive documentation about the WordPress REST API media endpoints"
...
<example>
Context: The user is troubleshooting an issue with a WordPress package.
user: "Why is the @wordpress/scripts build not working as expected?"
assistant: "Let me use the framework-docs-researcher agent to investigate the @wordpress/scripts documentation and source code"
